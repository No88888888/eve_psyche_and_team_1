          ...
          <div className="font-sans">
              ...
              <div>
                <div className="bg-[#EFFFF9] rounded-xl w-[90%] h-[75px] mx-auto my-[5%] drop-shadow-md flex">
                  <div className="my-auto ml-[3%]">
                    <img src="/img/toothbrush.jpg" alt="toothbrush" className="w-[70px] h-[50px]" />
                  </div>
                  <div className="w-[100%]">
                    ...
                    <div className="ml-[45%]">
                      <span className="text-xs text-[#9A9A9A]">기한만료 : 2023. 09. 08</span>
                    </div>
                  </div>
                </div>
                <div className="bg-[#F9F9F9] rounded-xl w-[90%] h-[75px] mx-auto my-[5%] flex">
                  ...
                  <div className="w-[100%]">
                    ...
                    <div className="ml-[45%]">
                      <span className="text-xs text-[#9A9A9A]">기한만료 : 2023. 10. 15</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-[#F9F9F9] rounded-xl w-[90%] h-[75px] mx-auto my-[5%] flex">
              ...
              <div className="w-[100%]">
                ...
                <div className="ml-[45%]">
                  <span className="text-xs text-[#9A9A9A]">기한만료 : 2023. 09. 24</span>
                </div>
              </div>
            </div>
            <div className="bg-[#F9F9F9] rounded-xl w-[90%] h-[75px] mx-auto my-[5%] flex">
              <div className="my-auto ml-[3%]">
                <img src="/img/ecofood.png" alt="ecofood" className="w-[70px] h-[50px]" />
              </div>
              <div className="w-[100%]">
                <div className="ml-[5%] mt-[6%]">
                ...
                <div className="ml-[45%]">
                  <span className="text-xs text-[#9A9A9A]">기한만료 : 2023. 06. 07</span>
                </div>
              </div>
            </div>
            <div className="bg-[#F9F9F9] rounded-xl w-[90%] h-[75px] mx-auto mt-[5%] mb-[35%] flex">
              ...
              <div className="w-[100%]">
                ...
                <div className="ml-[45%]">
                  <span className="text-xs text-[#9A9A9A]">기한만료 : 2022. 11. 19</span>
                </div>
              </div>
            </div>
          </div>
